...
print("Access Key:", creds.access_key[:6] + "****")  # partial
print("Session Token exists:", bool(creds.token))
print("Secret Key exists:", bool(creds.secret_key))
print("Credential Provider:", session.get_credentials().method)
